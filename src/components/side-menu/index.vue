	...
	<div class="menu-container">
		<el-menu active-text-color="#ffd04b" :default-openeds="['1']"  default-active="1-1" unique-opened background-color="#545c64" class="el-menu-vertical-demo" text-color="#fff" ref="menuRef" @open="handleOpen" @close="handleClose">
			...
			<el-sub-menu index="2">
				...
				<el-menu-item-group title="添加用户">
					<el-menu-item index="2-1" @click="selectSubMenu">添加用户</el-menu-item>
				</el-menu-item-group>
				<el-menu-item-group title="用户列表">
					<el-menu-item index="2-2" @click="selectSubMenu">用户列表</el-menu-item>
				</el-menu-item-group>
			</el-sub-menu>
			<el-sub-menu index="3">
				<template #title>
				...
				<el-menu-item-group title="添加用户">
					<el-menu-item index="3-1" @click="selectSubMenu">添加用户</el-menu-item>
				</el-menu-item-group>
				<el-menu-item-group title="用户列表" >
					<el-menu-item index="3-2" @click="selectSubMenu">用户列表</el-menu-item>
				</el-menu-item-group>
			</el-sub-menu>
		</el-menu>
	</div>
